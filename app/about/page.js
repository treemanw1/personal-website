...
export default function About() {
	...
	return (
		<>
			{/* Landscape */}
			<div className='portrait:hidden flex w-[45%] justify-between bg-blue-30 text-lg mt-2 pb-[10vh] leading-tight'>
			...
			{/* Portrait */}
			<div className='landscape:hidden flex justify-between px-[5%] text-lg mt-[10%] leading-tight'>
				<div className="flex flex-col gap-y-3 justify-between w-[50%] bg-green-30">
					<div className="flex flex-col">
						<p className="font-semibold">WEE NEVILLE</p>
						<p className="">Aspiring Software Engineer</p>
						{/* <p className="">wee.neville@proton.me</p> */}
				...
				<div className="flex flex-col justify-between items-end gap-y-5 w-[40%] bg-pink-30">
					<img className="w-[60%] grayscale" src='/images/passport.jpg'></img>
					<div className="flex flex-col text-right">
						<p className="font-semibold">LINKS</p>
