...
function Navbar() {
	return (
        <div className='flex items-center gap-x-3'>
            ...
            <Link title='My GitHub' className='flex items-center justify-center h-6 w-6' href='https://github.com/treemanw1'>
            ...
            <Link title='My LinkedIn' className='flex items-center justify-center h-6 w-6 p-[2px]' href=''>
            ...
            <Link title='My Spotify' className='flex items-center justify-center h-6 w-6 p-[2px]' href='https://open.spotify.com/user/21cybi2de2gqhhmevcmut7sfq?si=8739c37bf48d4f31'>
